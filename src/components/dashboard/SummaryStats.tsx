 ...
 */
const SummaryStats: React.FC<SummaryStatsProps> = ({ summary, className = '' }) => {
  return (
    <div className={`${className}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          ></div>
          <p className="text-xs uppercase mb-1" style={{ color: 'var(--neon-green)' }}>
            COMMIT COUNT
          </p>
        ...
        >
          ...
          ></div>
          <p className="text-xs uppercase mb-1" style={{ color: 'var(--electric-blue)' }}>
            REPOSITORIES
          </p>
          <p className="text-3xl font-mono" style={{ color: 'var(--foreground)' }}>
        ...
        >
          ...
          ></div>
          <p className="text-xs uppercase mb-1" style={{ color: 'var(--luminous-yellow)' }}>
            ACTIVE DAYS
          </p>
          <p className="text-3xl font-mono" style={{ color: 'var(--foreground)' }}>
