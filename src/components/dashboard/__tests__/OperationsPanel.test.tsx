...
jest.mock('@/lib/dashboard-utils', () => ({
  getGitHubAppInstallUrl: jest
    .fn()
    .mockReturnValue('https://github.com/apps/gitpulse/installations/new'),
}))
...
describe('OperationsPanel', () => {
  ...
  test('renders component with oauth auth method', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} authMethod="oauth" currentInstallations={[]} />
    )
  ...
  test('renders with error message', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} error="Something went wrong" />
    )
  ...
  test('renders with authentication error and reinitialize button', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} error="GitHub authentication issue detected" />
    )
  ...
  test('renders organization picker for my-work-activity mode', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} activityMode="my-work-activity" />
    )
  ...
  test('renders organization picker for team-activity mode', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} activityMode="team-activity" />
    )
  ...
  test('does not render organization picker for my-activity mode', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} activityMode="my-activity" />
    )
  ...
  test('passes loading state to child components', () => {
    const rendered = mockRenderer.render(
      <OperationsPanel {...defaultProps} loading={true} activityMode="team-activity" />
    )
