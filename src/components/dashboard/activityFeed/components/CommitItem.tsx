...
const CommitItem = React.memo(
  ({ commit, showRepository, showContributor, style, isNew = false }: CommitItemProps) => {
    ...
    return (
      ...
      >
        ...
        <div
          className={`border rounded-md p-3 mb-3 ${isNew ? 'animate-pulse-highlight animate-border-pulse' : ''}`}
          style={{
