        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <h3
              ...
              style={{
                color: isDebouncing ? 'var(--neon-green)' : 'var(--electric-blue)',
      ...
      <div className="p-4">
        ...
        <button
          ...
          style={{
            ...
            borderColor:
              internalSelection.length === 0 ? 'var(--electric-blue)' : 'var(--neon-green)',
        ...
        {isLoading && (
          <div className="mt-2 flex items-center text-xs" style={{ color: 'var(--electric-blue)' }}>
            <span
              ...
              style={{ borderColor: 'var(--electric-blue)', borderTopColor: 'transparent' }}
            ></span>
