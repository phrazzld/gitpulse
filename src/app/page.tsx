...
export default function Home() {
  ...
  if (isLoading && status === 'authenticated') {
    return (
      <AuthLoadingScreen message="Authenticated" subMessage="Redirecting to your dashboard..." />
    )
  }
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-2xl mb-8 flex flex-col items-center">
        <div
          className="inline-flex items-center border border-neon-green p-2 rounded-md mb-3"
          style={{ borderColor: 'var(--neon-green)' }}
        >
          <span className="text-xs px-2" style={{ color: 'var(--neon-green)' }}>
      ...
      {/* Main Card */}
      <div
        className="card w-full max-w-md p-8 space-y-8 border-2"
        style={{
      ...
      >
        ...
        <div
          className="space-y-6 p-4 border border-opacity-50 rounded-md"
          style={{
      ...
      <footer className="mt-8 text-center">
        ...
        <p className="text-sm mb-1" style={{ color: 'var(--electric-blue)' }}>
